...
const systemFiles = [
  ...
  '.pi/skills/career-ops/SKILL.md', '.pi/prompts/career-ops.md',
];
...
const absPathResult = run(
  `git grep -n "/Users/" -- '*.mjs' '*.sh' '*.md' '*.go' '*.yml' 2>/dev/null | grep -v README.md | grep -v LICENSE | grep -v AGENTS.md | grep -v test-all.mjs`
);
if (!absPathResult) {
...
const requiredSections = [
  ...
  'First Run', 'Onboarding', 'Pi Commands',
];
