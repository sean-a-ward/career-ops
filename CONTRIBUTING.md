...
Thanks for your interest in contributing! Career-Ops is built with Pi, and you can use it for development too.
...
- Keep modes language-agnostic when possible (Pi handles both EN and ES)
